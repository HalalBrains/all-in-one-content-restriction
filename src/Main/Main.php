 ...
 *
 * @package AllInOneContentRestriction\Main
 */

declare(strict_types=1);

namespace AllInOneContentRestriction\Main;

use AllInOneContentRestrictionPluginVendor\EightshiftLibs\Main\AbstractMain;
