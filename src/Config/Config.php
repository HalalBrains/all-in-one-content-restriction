 ...
 *
 * @package AllInOneContentRestriction\Config
 */

declare(strict_types=1);

namespace AllInOneContentRestriction\Config;

use AllInOneContentRestrictionPluginVendor\EightshiftLibs\Config\AbstractConfigData;
