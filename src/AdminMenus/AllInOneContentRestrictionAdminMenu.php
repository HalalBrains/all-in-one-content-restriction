 ...
 *
 * @package AllInOneContentRestriction\AdminMenus
 */

declare(strict_types=1);

namespace AllInOneContentRestriction\AdminMenus;

use AllInOneContentRestrictionPluginVendor\EightshiftLibs\AdminMenus\AbstractAdminMenu;

/**
 * AllInOneContentRestrictionAdminMenu class.
 */
class AllInOneContentRestrictionAdminMenu extends AbstractAdminMenu
{
	/**
	 ...
	 * @var string
	 */
	public const ADMIN_MENU_SLUG = 'all-in-one-content-restriction';
	...
	{
		return \esc_html__('All in One Content Restriction', 'all-in-one-content-restriction');
	}
	...
	{
		return \esc_html__('AIO Content Restriction', 'all-in-one-content-restriction');
	}
	...
	{
		return [
			'pageTitle' => \esc_html__('All in One Content Restriction', 'all-in-one-content-restriction'),
		];
	}
}
