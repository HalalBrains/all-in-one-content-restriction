 ...
 *
 * @package AllInOneContentRestriction\Manifest
 */

declare(strict_types=1);

namespace AllInOneContentRestriction\Manifest;

use AllInOneContentRestriction\Config\Config;
use AllInOneContentRestrictionPluginVendor\EightshiftLibs\Manifest\AbstractManifest;
