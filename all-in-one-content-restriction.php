...
if ( ! class_exists( 'All_In_One_Content_Restriction' ) ) {
	class All_In_One_Content_Restriction {
		...
		public function includes() {
			...
			if ( isset( $_REQUEST['page'] ) && in_array( $_REQUEST['page'], array( 'all-in-one-content-restriction', 'all-in-one-content-restriction', 'dashboard', 'restrictions' ) ) && ! class_exists( 'Hide_Admin_Notices' ) ) {
