...
<fieldset>
	...
	<div class="form-card">
		...
		<?php Helper::get_template_part_admin( 'menu-page/protections/override-contents', $args );?>
		<?php Helper::get_template_part_admin( 'menu-page/protections/redirect', $args );?>
		<?php Helper::get_template_part_admin( 'menu-page/protections/blur', $args );?>
		<?php Helper::get_template_part_admin( 'menu-page/protections/obfuscate', $args );?>
