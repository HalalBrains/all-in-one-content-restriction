...
<div class="part4 mb-3" id="blur">
	...
	<div class="slider-group">
		<div class="slider-range blur_level"></div>
	...
	<div class="slider-group">
		<div class="slider-range spread"></div>
	...
	<select id="blur_apply_to" class="form-control" multiple>
		<option value="the_title">Title</option>
		<option value="the_excerpt">Excerpt</option>
		<option value="the_content">Descriptions</option>
	</select>
</div>